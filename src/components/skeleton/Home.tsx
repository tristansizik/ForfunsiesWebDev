...
export default function BodyInfo() {
    return(
      <main className="flex flex-col justify-center items-center h-screen w-full pt-24 px-4 bg-coral ">
        ...
        <div className= "flex md:flex-row flex-col h-4/5 md:h-1/2 w-2/3 px-4 py-4 md:mb-10 bg-vivid-red text-center animate-fade-in-p7">
          <img className=" mx-10 max-w-full mb-2" src='./images/1.jpg' alt="Me :)" />
          <div className="flex flex-col justify-center items-center w-2/3 h-full mx-10">
            <h1 className="font-Helvetica font-bold text-lg md:text-6xl text-dark-grayish-blue animate-fade-in-1s">TRISTAN SIZIK –</h1>
