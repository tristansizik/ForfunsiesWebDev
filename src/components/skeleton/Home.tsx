...
export default function BodyInfo() {
    return(
      <main className="flex flex-col justify-center items-center h-screen w-full pt-24 px-4 bg-coral ">
        ...
        <div className= "flex flex-row h-1/2 w-2/3 px-4 py-4 mb-10 bg-vivid-red text-center">
          ...
          <div className="flex flex-col justify-center items-center w-2/3 h-full mx-10  z-10 ">
            <h1 className="font-Helvetica font-bold text-6xl text-dark-grayish-blue">TRISTAN SIZIK –</h1>
            ...
            <p className='font-Helvetica font-bold text-sm text-dark-grayish-blue mt-5'>Currently In My Orbit:<br/>Event Production<br/>Music Production<br/>DJing<br/>Running </p>
          </div>
        </div>
        <FootBar></FootBar>
      </main>
