...
export default function BodyInfo() {
    return(
      <main className= "flex flex-col justify-between items-center p-5% min-h-screen animate-fade-in-p7 space-y-1">
        <div className="justify-center items-center sticky top-3% h-24 w-full bg-pink-100 rounded-12px">
          <NavBar/>    
        </div>
        <div className="justify-center flex min-h-screen w-full bg-pink-200 rounded-12px">Under Construction !!!!</div>
